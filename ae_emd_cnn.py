...
class ae_EMD_CNN:
    ...
    def ittrain(test_ae_directory,num_filt, kernel_size, num_dens_neurons, num_dens_layers, num_conv_2d, num_epochs,Loss):
        ...
        current_directory='/ecoderemdvol/EleGun/EMD/EPGun-PU200/eta_1/ae/'
        ...
        callbacks = [ModelCheckpoint('/ecoderemdvol/EleGun/EMD/EPGun-PU200/eta_1/ae/ae_emd_models/'+str(num_filt)+str(kernel_size)+str(num_dens_neurons)+str(num_dens_layers)+str(num_conv_2d)+str(num_epochs)+Loss+'best.h5', monitor='val_loss', verbose=1, save_best_only=True),
                     ModelCheckpoint('/ecoderemdvol/EleGun/EMD/EPGun-PU200/eta_1/ae/ae_emd_models/'+str(num_filt)+str(kernel_size)+str(num_dens_neurons)+str(num_dens_layers)+str(num_conv_2d)+str(num_epochs)+Loss+'last.h5', monitor='val_loss', verbose=1, save_last_only=True),
                    ]
